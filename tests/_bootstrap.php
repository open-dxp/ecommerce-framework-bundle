...
Autoloader::addNamespace('OpenDxp\Bundle\EcommerceFrameworkBundle\Tests', __DIR__);
Autoloader::addNamespace('OpenDxp\Bundle\EcommerceFrameworkBundle\Tests', __DIR__ . '/_support');
