# OpenDxpEcommerceFrameworkBundle Configuration Reference

The following is the generated reference for the `opendxp_ecommerce_framework` configuration tree. This reference can
be generated by issuing the following command:

    $ bin/console config:dump-reference opendxp_ecommerce_framework
...
```yaml
# Default configuration for extension with alias: "opendxp_ecommerce_framework"
opendxp_ecommerce_framework:

    # Default scale used for Decimal objects
    decimal_scale:        4

    # Configuration of OpenDxp backend menu entries
    opendxp:
        menu:
            ...
            order_list:
                enabled:              true
                route:                opendxp_ecommerce_backend_admin-order_list
                path:                 null
    ...
    factory:
        ...
        factory_id:           OpenDxp\Bundle\EcommerceFrameworkBundle\Factory
    ...
    environment:
        environment_id:       OpenDxp\Bundle\EcommerceFrameworkBundle\SessionEnvironment
        options:              []
    ...
    cart_manager:
        ...
        tenants:
            ...
            name:
                ...
                price_calculator:
                    factory_id:           OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\CartPriceCalculatorFactory
                    factory_options:
                        ...
                        class: OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\CartPriceCalculator
    ...
    pricing_manager:
        ...
        tenants:
            ...
            name:
                ...
                pricing_manager_id:   OpenDxp\Bundle\EcommerceFrameworkBundle\PricingManager\PricingManager
    ...
    index_service:
        index_service_id:     OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\IndexService
    ...
    filter_service:
        ...
        tenants:
            ...
            name:
                enabled:              true
                service_id:           OpenDxp\Bundle\EcommerceFrameworkBundle\FilterService\FilterService
    ...
    voucher_service:
        ...
        voucher_service_id:   OpenDxp\Bundle\EcommerceFrameworkBundle\VoucherService\DefaultService
        ...
        token_managers:
            ...
            factory_id:           OpenDxp\Bundle\EcommerceFrameworkBundle\VoucherService\TokenManager\TokenManagerFactory
    ...
    offer_tool:
        ...
        service_id:           OpenDxp\Bundle\EcommerceFrameworkBundle\OfferTool\DefaultService
        order_storage:

            # OpenDxp object class for offers
            offer_class:          OpenDxp\Model\DataObject\OfferToolOffer

            # OpenDxp object class for offer items
            offer_item_class:     OpenDxp\Model\DataObject\OfferToolOfferItem
    ...
    tracking_manager:
        ...
        trackers:
            ...
            enhanced_ecommerce:
                ...
                item_builder_id:      OpenDxp\Bundle\EcommerceFrameworkBundle\Tracking\TrackingItemBuilder
