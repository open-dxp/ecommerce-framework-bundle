...
> Starting with OpenDxp 1.0 an optimized checkout manager architecture was introduced. This is parallel to the old 
> architecture, which is deprecated now and will be removed in OpenDxp 2.0. For details see [Checkout Manager Details](08_Checkout_Manager_Details.md).
