...
use OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\CartFactory;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\CartPriceCalculator;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\CartPriceCalculatorFactory;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\MultiCartManager;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CartManager\SessionCart;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CheckoutManager\CheckoutManagerFactory;
use OpenDxp\Bundle\EcommerceFrameworkBundle\CheckoutManager\V7\CommitOrderProcessor;
use OpenDxp\Bundle\EcommerceFrameworkBundle\DependencyInjection\Config\Processor\TenantProcessor;
use OpenDxp\Bundle\EcommerceFrameworkBundle\DependencyInjection\IndexService\DefaultWorkerConfigMapper;
...
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Config\DefaultMysql;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\IndexService;
use OpenDxp\Bundle\EcommerceFrameworkBundle\OfferTool\DefaultService as DefaultOfferToolService;
use OpenDxp\Bundle\EcommerceFrameworkBundle\OrderManager\Order\AgentFactory;
use OpenDxp\Bundle\EcommerceFrameworkBundle\OrderManager\Order\Listing;
use OpenDxp\Bundle\EcommerceFrameworkBundle\OrderManager\V7\OrderManager;
use OpenDxp\Bundle\EcommerceFrameworkBundle\PaymentManager\PaymentManager;
use OpenDxp\Bundle\EcommerceFrameworkBundle\PricingManager\Environment;
use OpenDxp\Bundle\EcommerceFrameworkBundle\PricingManager\PriceInfo;
...
use OpenDxp\Bundle\EcommerceFrameworkBundle\SessionEnvironment;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Tracking\TrackingItemBuilder;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Tracking\TrackingManager;
use OpenDxp\Bundle\EcommerceFrameworkBundle\VoucherService\DefaultService as DefaultVoucherService;
use OpenDxp\Bundle\EcommerceFrameworkBundle\VoucherService\TokenManager\TokenManagerFactory;
...
final readonly class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('opendxp_ecommerce_framework');
    ...
    private function buildOpenDxpNode(): NodeDefinition
    {
        ...
        $opendxp
            ->addDefaultsIfNotSet()
            ->info('Configuration of OpenDxp backend menu entries');
                ...
                ->arrayNode('menu')
                    ...
                    ->children()
                        ...
                        ->arrayNode('order_list')
                            ...
                            ->children()
                                ->scalarNode('route')
                                    ->defaultValue('opendxp_ecommerce_backend_admin-order_list')
                                ->end()
                                ->scalarNode('path')
                                    ->defaultNull()
                                ->end()
