...
namespace OpenDxp\Bundle\EcommerceFrameworkBundle\DependencyInjection\IndexService;

use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Config\DefaultFindologic as DefaultFindologicConfig;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Config\DefaultMysql as DefaultMysqlConfig;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Config\DefaultMysqlSubTenantConfig;
...
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\DefaultFindologic;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\DefaultMysql;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\ElasticSearch\DefaultElasticSearch8;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\OpenSearch\DefaultOpenSearch;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\OptimizedMysql;
