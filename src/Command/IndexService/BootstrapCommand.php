...
use OpenDxp\Console\Traits\Timeout;
...
class BootstrapCommand extends AbstractIndexServiceCommand
{
    ...
    protected function configure(): void
    {
        ...
        $this
            ...
            ->addOption('object-list-class', null, InputOption::VALUE_REQUIRED, 'The object list class to use', '\\OpenDxp\\Model\\DataObject\\Product\\Listing')
