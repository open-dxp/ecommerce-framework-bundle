...
abstract class AbstractOfferItem extends Concrete
{
     ...
     */
    abstract public function getProduct(): ?\OpenDxp\Model\Element\AbstractElement;

    /**
     * @return $this
     */
    abstract public function setProduct(?\OpenDxp\Model\Element\AbstractElement $product): static;
