...
use OpenDxp\Bundle\EcommerceFrameworkBundle\Event\CommitOrderProcessorEvents;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Event\Model\CommitOrderProcessorEvent;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Event\Model\SendConfirmationMailEvent;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Exception\PaymentNotSuccessfulException;
...
class CommitOrderProcessor implements CommitOrderProcessorInterface, LoggerAwareInterface
{
    ...
    protected function sendConfirmationMail(AbstractOrder $order): void
    {
        ...
        if (!$event->doSkipDefaultBehaviour()) {
            ...
            $mail = new \OpenDxp\Mail(['document' => $event->getConfirmationMailConfig(), 'params' => $params]);
