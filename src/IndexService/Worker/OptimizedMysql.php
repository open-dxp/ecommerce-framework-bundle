...
class OptimizedMysql extends AbstractMockupCacheWorker implements BatchProcessingWorkerInterface
{
    ...
    public function getProductList(): \OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\ProductList\DefaultMysql
    {
        return new \OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\ProductList\DefaultMysql($this->getTenantConfig(), $this->logger);
    }
}
