...
namespace OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Worker\Helper;
...
class MySql
{
    ...
    public function __destruct()
    {
        ...
        if ($this->_sqlChangeLog !== []) {
            ...
            $file = OPENDXP_SYSTEM_TEMP_DIRECTORY.'/'.$filename;
            if (defined('OPENDXP_DB_CHANGELOG_DIRECTORY')) {
                $file = OPENDXP_DB_CHANGELOG_DIRECTORY.'/'.$filename;
            }
