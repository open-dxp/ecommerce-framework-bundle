...
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Exception\DefaultWorkerNotFoundException;
use OpenDxp\Bundle\EcommerceFrameworkBundle\IndexService\Exception\WorkerNotFoundException;
