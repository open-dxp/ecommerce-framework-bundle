...
abstract class AbstractOrder extends Concrete
{
     ...
     * @return $this
     */
    abstract public function setPaymentInfo(?\OpenDxp\Model\DataObject\Fieldcollection $paymentInfo): static;

    abstract public function getPaymentProvider(): ?\OpenDxp\Model\DataObject\Objectbrick;
     ...
     * @return $this
     */
    abstract public function setSuccessorOrder(?\OpenDxp\Model\Element\AbstractElement $successorOrder): static;
}
