...
class VoucherController extends UserAwareController implements KernelControllerEventInterface
{
     ...
     */
    #[Route('/voucher-code-tab', name: 'opendxp_ecommerce_backend_voucher_voucher-code-tab', methods: ['GET'])]
     ...
     */
    #[Route('/export-tokens', name: 'opendxp_ecommerce_backend_voucher_export-tokens', methods: ['GET'])]
     ...
     */
    #[Route('/generate', name: 'opendxp_ecommerce_backend_voucher_generate', methods: ['GET'])]
     ...
     */
    #[Route('/cleanup', name: 'opendxp_ecommerce_backend_voucher_cleanup', methods: ['POST'])]
     ...
     */
    #[Route('/cleanup-reservations', name: 'opendxp_ecommerce_backend_voucher_cleanup-reservations', methods: ['POST'])]
