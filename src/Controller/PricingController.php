...
class PricingController extends UserAwareController implements KernelControllerEventInterface
{
    ...
    #[Route('/list', name: 'opendxp_ecommerceframework_pricing_list', methods: ['GET'])]
     ...
     */
    #[Route('/get', name: 'opendxp_ecommerceframework_pricing_get', methods: ['GET'])]
    public function getAction(Request $request): JsonResponse
    {
        ...
        if ($rule) {
            ...
            foreach (\OpenDxp\Tool::getValidLanguages() as $lang) {
     ...
     * add new rule
     */
    #[Route('/add', name: 'opendxp_ecommerceframework_pricing_add', methods: ['POST'])]
     ...
     * delete exiting rule
     */
    #[Route('/delete', name: 'opendxp_ecommerceframework_pricing_delete', methods: ['DELETE'])]
     ...
     * copy existing rule
     */
    #[Route('/copy', name: 'opendxp_ecommerceframework_pricing_copy', methods: ['POST'])]
     ...
     * rename exiting rule
     */
    #[Route('/rename', name: 'opendxp_ecommerceframework_pricing_rename', methods: ['PUT'])]
     ...
     * save rule config
     */
    #[Route('/save', name: 'opendxp_ecommerceframework_pricing_save', methods: ['PUT'])]
    ...
    #[Route('/save-order', name: 'opendxp_ecommerceframework_pricing_save-order', methods: ['PUT'])]
    ...
    #[Route('/get-config', name: 'opendxp_ecommerceframework_pricing_get-config', methods: ['GET'])]
