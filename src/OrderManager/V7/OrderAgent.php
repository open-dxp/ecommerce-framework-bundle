...
use OpenDxp\Bundle\EcommerceFrameworkBundle\Event\Model\OrderAgentEvent;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Event\OrderAgentEvents;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Exception\PaymentNotAllowedException;
use OpenDxp\Bundle\EcommerceFrameworkBundle\Exception\ResponseWithAbortedPaymentStateException;
...
use OpenDxp\Model\DataObject\Fieldcollection\Data\PaymentInfo;
...
class OrderAgent implements OrderAgentInterface
{
    ...
    public function setPaymentProvider(PaymentInterface $paymentProvider, ?AbstractOrder $sourceOrder = null): static
    {
        ...
        if (!$providerData) {
            // create new
            $class = '\OpenDxp\Model\DataObject\Objectbrick\Data\PaymentProvider' . $paymentProvider->getName();
