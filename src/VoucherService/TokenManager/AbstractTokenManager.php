...
abstract class AbstractTokenManager implements TokenManagerInterface, ExportableTokenManagerInterface
{
    ...
    abstract public function applyToken(string $code, CartInterface $cart, \OpenDxp\Bundle\EcommerceFrameworkBundle\Model\AbstractOrder $order): OnlineShopVoucherToken|bool;
