...
namespace OpenDxp\Bundle\EcommerceFrameworkBundle\EventListener\Frontend;
...
use OpenDxp\Bundle\EcommerceFrameworkBundle\Tracking\Tracker\GoogleTagManager;
        ...
        foreach ($activeTrackers as $activeTracker) {
            if ($activeTracker instanceof GoogleTagManager) {
                ...
                $code = $this->twig->render(
                    '@OpenDxpGoogleMarketing/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig',
