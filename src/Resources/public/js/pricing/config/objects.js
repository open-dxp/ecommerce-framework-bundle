...
opendxp.registerNS("opendxp.bundle.EcommerceFramework.pricing.config.objects");
/**
 * @private
 */
opendxp.bundle.EcommerceFramework.pricing.config.objects = Class.create(opendxp.object.tags.manyToManyObjectRelation, {
