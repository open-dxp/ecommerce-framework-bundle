...
opendxp.registerNS("opendxp.bundle.EcommerceFramework.VoucherSeriesTab");

/**
 * @private
 */
opendxp.bundle.EcommerceFramework.VoucherSeriesTab = Class.create({
    ...
    initialize: function(object, type) {
        ...
        this.type = type;
        this.src = Routing.generate('opendxp_ecommerce_backend_voucher_voucher-code-tab', {id: this.id});
    },
