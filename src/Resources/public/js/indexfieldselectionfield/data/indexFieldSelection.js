...
opendxp.registerNS("opendxp.object.classes.data.indexFieldSelection");
/**
 * @private
 */
opendxp.object.classes.data.indexFieldSelection = Class.create(opendxp.object.classes.data.data, {
    ...
    getIconClass: function () {
        return "opendxp_icon_indexFieldSelection";
    },
    ...
    getLayout: function ($super) {
        ...
        var filterGroups = Ext.create('Ext.ux.form.MultiSelect', {
            ...
            store: new Ext.data.JsonStore({
                ...
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_ecommerceframework_index_getfiltergroups'),
                    reader: {
                        rootProperty: 'data',
                        idProperty: 'key'
                    }
