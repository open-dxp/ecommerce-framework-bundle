...
opendxp.registerNS("opendxp.object.tags.indexFieldSelection");
/**
 * @private
 */
opendxp.object.tags.indexFieldSelection = Class.create(opendxp.object.tags.select, {
    ...
    initialize: function (data, fieldConfig) {
        ...
        this.store = new Ext.data.JsonStore({
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_ecommerceframework_index_getfields'),
                reader: {
                    rootProperty: 'data',
                    idProperty: 'key'
                },
        ...
        if(this.fieldConfig.multiPreSelect == 'remote_single' || this.fieldConfig.multiPreSelect == 'remote_multi') {
            this.preSelectStore = new Ext.data.JsonStore({
                ...
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_ecommerceframework_index_getvaluesforfilterfield'),
                    reader: {
                        rootProperty: 'data',
                        idProperty: 'key'
                    },
        ...
        if(this.fieldConfig.considerTenants) {
            this.tenantStore = new Ext.data.JsonStore({
                ...
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_ecommerceframework_index_getalltenants'),
                    reader: {
                        rootProperty: 'data',
                        idProperty: 'key'
                    }
