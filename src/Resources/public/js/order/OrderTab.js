...
opendxp.registerNS("opendxp.bundle.EcommerceFramework.OrderTab");

/**
 * @private
 */
opendxp.bundle.EcommerceFramework.OrderTab = Class.create({

    title: t('bundle_ecommerce_order_tab'),
    iconCls: 'opendxp_icon_portlet_feed',
    src: null,
    id: null,
    ...
    initialize: function(object, type) {
        ...
        this.id = object.id;
        this.type = type;
        this.src = Routing.generate('opendxp_ecommerce_backend_admin-order_detail', {id: this.id});
    },
